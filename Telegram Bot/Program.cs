...
namespace Telegram_Bot
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //var awaiter = stockData.GetStockData(symbol, startDate, endDay);
            //if (awaiter.Result == 1)
            //{
            //    Console.WriteLine();
            //    Console.WriteLine("SUCCESS 1");
            //}
            //var awaiter2 = stockData.CheckPredict(symbol, 145);
            //if (awaiter2.Result == 1)
            //{
            //    Console.WriteLine("CheckPredict");
